...
#ifndef __InterfaceDefine_H_
#define __InterfaceDefine_H_
...
typedef struct Imitate
{
    Drv_Uint16Type  *ScreenSprt;
    Drv_Uint16Type  WSelected;
    Drv_Uint16Type  HSelected;
    Drv_Uint16Type  movestepx;
    Drv_Uint16Type  movestepy;

    Drv_Uint16Type  frontcolor;
    Drv_Uint16Type  backcolor;
    Drv_Uint16Type  Screen[HScreen][WScreen];
    Drv_Uint32Type  ScreenSize;
}__ImitateScreen_TyDef;

extern __ImitateScreen_TyDef _ImitScreen;
